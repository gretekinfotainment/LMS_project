...
if (!$isLoggedIn) {
    ...
    <div class="landing-page">
        ...
        <!-- Partners Section -->
        <div class="section partners-section" id="partners">
            <div class="section-container">
                <div class="section-heading">
                    <h2>Our Partners</h2>
                    <p class="section-subheading">Collaborating with industry leaders to deliver excellence</p>
                </div>
                <div class="partners-grid">
                        <img src="' . $CFG->wwwroot . '/theme/boost/pix/partner1.png" alt="Partner">
                        <img src="' . $CFG->wwwroot . '/theme/boost/pix/partner2.png" alt="Partner">
                        <img src="' . $CFG->wwwroot . '/theme/boost/pix/partner3.png" alt="Partner">
                        <img src="' . $CFG->wwwroot . '/theme/boost/pix/partner4.png" alt="Partner">
                        <img src="' . $CFG->wwwroot . '/theme/boost/pix/partner5.png" alt="Partner">
                </div>
            </div>
        </div>
            ...
            <div class="section-container">
                <div class="footer-content">
                    ...
                    <div class="footer-contact">
                        <h4>Contact Us</h4>
                        <p><i class="fas fa-envelope"></i> gretek.infotainment@gmail.com</p>
                        <p><i class="fas fa-phone-alt"></i> +91 72005-50085 </p>
                    </div>
